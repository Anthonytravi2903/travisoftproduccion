...
<section class = "clases">
    <div class = "contenedor seccion">
        <h2 class = "text-center texto-primario">Nuestros Servicios</h2>

        <?php gymfitness_lista_clases(4)?>
        <div class = "contenedor-boton">
            <a href="<?php echo esc_url(get_permalink(get_page_by_title('Nuestros Servicios') ) );?>"
...
<section class="instructores">
    <div class="contenedor seccion">
        <h2 class="text-center texto-primario">Nuestros Colaboradores</h2>
        <p class="text-center">Desarrolladores profesionales que te ayudaran a cumplir tus metas</p>
...
<section class="blog contenedor seccion">
    ...
    <p class="text-center">Algunos tips útiles para empezar con tu proyecto</p>
